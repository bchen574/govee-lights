...
export default function Home() {
  ...
  return (
    <div className="bg-background grid h-full grid-cols-2 items-center justify-start gap-4 px-4 py-6 font-sans md:grid md:h-200 md:grid-cols-2 md:gap-4 md:px-6">
