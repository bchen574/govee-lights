...
export default function Home() {
  ...
  return (
    <div className="grid grid-cols-2 px-4  h-full gap-4 md:grid md:grid-cols-2 md:gap-4 md:h-200 items-center justify-start py-6 font-sans bg-background md:px-6">
